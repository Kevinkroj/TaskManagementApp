    ...
    useEffect(() => {
        ...
        const getUsers = async () => {
            try {
                ...
                dispatch(setUsers(sortedUsers)); // Dispatch action to store users in Redux
    ...
    return (
        <div className="dashboard-container">
            <div className="dashboard-header">
                <h1 className='title-dash'>{t('welcomedashboard')}</h1>
            </div>

            <div className="card-container">
                <div className="card">
                    <img src={totalIMG} alt={t('homeIconAlt')} className="link-icon" />
                    <div className='card-inside'>
                        <div className="card-title">{t('totalTasks')}</div>
                        <AnimatedNumber targetNumber={totalTask} />
                    </div>
                </div>
                <div className="card">
                    <img src={progressIMG} alt={t('homeIconAlt')} className="link-icon" />
                    <div className='card-inside'>
                        <div className="card-title">{t('inProgress')}</div>
                        <AnimatedNumber targetNumber={totalTaskInProgress} />
                    </div>
                </div>
                <div className="card">
                    <img src={reviewIMG} alt={t('homeIconAlt')} className="link-icon" />
                    <div className='card-inside'>
                        <div className="card-title">{t('underReview')}</div>
                        <AnimatedNumber targetNumber={totalTaskReview} />
                    </div>
                </div>
                <div className="card">
                    <img src={completedIMG} alt={t('homeIconAlt')} className="link-icon" />
                    <div className='card-inside'>
                        <div className="card-title">{t('completed')}</div>
            ...
            <div className="list-section">
                ...
                <div className="main-list">
                    ...
                    <div className="header-row">
                        <div className="header-item">{t('task')}</div>
                        <div className="header-item">{t('assigned')}</div>
                        <div className="header-item">{t('finished')}</div>
                ...
                <div className="side-list">
                    <p>{t('teamScore')}</p>
                    <ul>
                        {users.slice(0, 5).map((user: any, index: any) => (
                            <li key={index}>
                                <div className='user-score'>{user.email}</div>
                                <div className="user-score">
                                    {t('completedTasks')} <span style={{ color: 'green', marginLeft: 20, fontSize: 22 }}>
